function(setupCmakeOptionDependencies)
  ...
  if ( arg_OPTIONAL )
    foreach(_dep IN LISTS arg_OPTIONAL)
      set(_enabled ON)
      if ( DEFINED FEELPP_ENABLE_DEFAULT_OPTION_${_dep} )
        set(_enabled ${FEELPP_ENABLE_DEFAULT_OPTION_${_dep}})
      endif()
...
macro(importDependency_CGAL _useSystem _target_dependencies _target_definitions _cmakeVariablePrefix)
  ...
  if ( CGAL_FOUND )
    ...
    # another workaround : dummy version (see https://github.com/CGAL/cgal/blob/main/Installation/cmake/modules/CGAL_Eigen3_support.cmake#L2)
    if (FEELPP_HAS_EIGEN3 AND NOT Eigen3_VERSION)
